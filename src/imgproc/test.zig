...
test "imgproc morphologyDefaultBorderValue" {
    const morphologyDefaultBorderValue = imgproc.morphologyDefaultBorderValue();
...
test "imgproc calcHist" {
    ...
    try imgproc.calcHist(m[0..], chans[0..], mask, &dst, size[0..], rng[0..], false);
    try testing.expectEqual(false, dst.isEmpty());
...
test "imgproc compareHist" {
    ...
    var size = [1]i32{256};
    var rng = [2]f32{ 0.0, 256.0 };
    try imgproc.calcHist(m[0..], chans[0..], mask, &hist1, size[0..], rng[0..], false);
    try testing.expectEqual(false, hist1.isEmpty());
    try imgproc.calcHist(m[0..], chans[0..], mask, &hist2, size[0..], rng[0..], false);
